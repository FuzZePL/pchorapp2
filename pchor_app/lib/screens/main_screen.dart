...
import 'package:pchor_app/screens/login_screen.dart'; 
import 'package:pchor_app/screens/duties_screen.dart'; 
import 'package:pchor_app/screens/points_screen.dart'; 
...
class _MainScreenState extends State<MainScreen> {
  ...
  bool _isLoading = true; // Flaga do pokazywania ładowania podczas sprawdzania logowania
    ...
    switch (item) {
      ...
      case 'duties':
        Navigator.of(context).push(
          MaterialPageRoute(builder: (context) => const DutiesScreen()),
        );
        break;
      case 'points':
        Navigator.of(context).push(
