...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    final bool registrationSuccessful = await authManager.registerUser(email, password, name, surname);
    ...
    if (registrationSuccessful) {
      ...
      Fluttertoast.showToast(msg: "Rejestracja nieudana. Użytkownik już istnieje lub błąd.");
    }
